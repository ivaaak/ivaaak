...
- **Misc ----  [React + Express + Claude SDK: JSON Translate](https://github.com/ivaaak/JSON-Translator) ----- [React - Image to ASCII](https://github.com/ivaaak/React-Image-To-ASCII) ----- [React - Tree File Explorer](https://github.com/ivaaak/file-explorer) ----- [Typescript BTC](https://github.com/ivaaak/Bitcoin-Typescript)**
